...
//note: do not delete or comment out any addresses!!!
        //register number is determined by order
typedef volatile struct
{
  ...
  uint8 MBARC_MAG_RX;        //0x5E   
} CDH_IO_t;

#define CDH_IO_ADDR 0xFF8000

#define STS1_UNUSED2                      0x80
#define STS1_CDH_IMU1_READY               0x40
#define STS1_MBARC_MAG_RX_EMPTY           0x20
...
#define STS2_UNUSED2                      0x80
#define STS2_UNUSED1                      0x40
...
#define STS3_UNUSED1                      0x01

#define STS4_CPUFIFO_FF                   0x80
#define STS4_IMU2_TX_FIFO_FF              0x40
#define STS4_MBARC_MAG_RX_FIFO_FF         0x20
#define STS4_MBARC_MAG_TX_FIFO_FF         0x10
...
#define PWR_MBARC_MAG                     0x80
#define PWR_EPS_ADC                       0x40
#define PWR_FIPEX                         0x20
