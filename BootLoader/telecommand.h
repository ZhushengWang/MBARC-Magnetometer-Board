...
#define LI1_TX_ENABLE        0xA4
#define MSG_TX_ENABLE        0xA5
#define ACK_TX_ENABLE        0xA6
#define SET_INIT_WAIT        0xA7
#define READ_OP_STATUS       0xA8
#define SET_TIME             0xA9
#define SET_LAUNCH           0xAA
#define SET_ENABLE_DEPLOY    0xAB
#define SET_PHASE            0xAC
#define MBARC_MAG_STOP       0xAD
#define MBARC_MAG_RESET      0xAE
