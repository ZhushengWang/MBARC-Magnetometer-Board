...
#define FIPEX_LOAD_SCRIPT    0xB2
#define FIPEX_VERIFY_SCRIPT  0xB3
#define FIPEX_SET_ACT_SCRIPT 0xB4
#define FIPEX_PRINT_SCRIPT   0xB5
#define FIPEX_LIST_SCRIPT    0xB6
#define FIPEX_ERASE_SCRIPT   0xB7
#define FIPEX_SCRIPT_PROC    0xB8
#define HK_TX_ENABLE         0xB9
#define FIPEX_ERASE_DATA     0xBA
#define FIPEX_RETRIEVE_DATA  0xBB
#define FIPEX_INIT_RETRIEVAL 0xBC
#define FIPEX_DP             0xBD
#define INIT_DEPLOY_COUNT    0xBE
