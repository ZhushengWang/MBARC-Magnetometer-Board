...
uint32 Swap32(uint32 unVal)
{
uint32 unSwapped;

  ((uint8 *)&unSwapped)[0] = ((uint8 *)&unVal)[3];
  ((uint8 *)&unSwapped)[1] = ((uint8 *)&unVal)[2];
  ((uint8 *)&unSwapped)[2] = ((uint8 *)&unVal)[1];
  ((uint8 *)&unSwapped)[3] = ((uint8 *)&unVal)[0];
  
  return(unSwapped);
}

uint16 Swap16(uint16 uwVal)
{
uint16 uwSwapped;

  ((uint8 *)&uwSwapped)[0] = ((uint8 *)&uwVal)[1];
  ((uint8 *)&uwSwapped)[1] = ((uint8 *)&uwVal)[0];
